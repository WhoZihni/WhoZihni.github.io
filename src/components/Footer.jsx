    ...
    <footer className="footer">
      <div className="footer-inner">
        <div className="footer-links">
          <a href="mailto:ahmedzihni27@gmail.com" className="footer-link">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
              <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
              <polyline points="22,6 12,13 2,6" />
            </svg>
            ahmedzihni27@gmail.com
          </a>
          <a href="https://github.com/WhoZihni" className="footer-link" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://www.linkedin.com/in/ahmed-zihni-4443b03a5/" className="footer-link" target="_blank" rel="noopener noreferrer">
            <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <p className="footer-copy">
          &copy; 2025 Ahmed Zihni. All rights reserved.
        </p>
      </div>
    </footer>
  )
